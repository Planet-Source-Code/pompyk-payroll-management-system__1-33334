...
Begin VB.Form Form8 
   BackColor       =   &H00404040&
   Caption         =   "DIRECT QUERIES - EMPLOYEE"
   ClientHeight    =   7305
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11865
   Icon            =   "directqueries.frx":0000
   LinkTopic       =   "Form8"
   MDIChild        =   -1  'True
   ScaleHeight     =   7305
   ScaleWidth      =   11865
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "directqueries.frx":030A
      Height          =   3615
      Left            =   600
      TabIndex        =   3
      Top             =   3600
   ...
   Begin VB.CommandButton cmdquery 
      ...
      Width           =   5055
   End
   Begin VB.TextBox txtdirectquery 
      Appearance      =   0  'Flat
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
      ...
      MultiLine       =   -1  'True
      TabIndex        =   0
      Text            =   "directqueries.frx":031F
      Top             =   1440
      Width           =   5775
   End
   Begin VB.Label Label1 
      BackColor       =   &H00808080&
      Caption         =   $"directqueries.frx":0338
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
