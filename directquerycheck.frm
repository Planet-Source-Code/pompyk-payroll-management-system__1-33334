...
Begin VB.Form Form9 
   BackColor       =   &H00404040&
   Caption         =   "DIRECT QUERY CHECK"
   ClientHeight    =   6405
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8535
   Icon            =   "directquerycheck.frx":0000
   LinkTopic       =   "Form9"
   MDIChild        =   -1  'True
   ScaleHeight     =   6405
   ScaleWidth      =   8535
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select * from chequedetail"
      Caption         =   "Adodc1"
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "directquerycheck.frx":030A
      Height          =   2775
      Left            =   120
      TabIndex        =   2
      Top             =   3240
   ...
   Begin VB.CommandButton cmdquery 
      ...
      Width           =   1815
   End
   Begin VB.TextBox textdirectcheck 
      Appearance      =   0  'Flat
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
      ...
      MultiLine       =   -1  'True
      TabIndex        =   0
      Text            =   "directquerycheck.frx":031F
      Top             =   1320
      Width           =   6255
   End
   Begin VB.Label Label1 
      BackColor       =   &H00808080&
      Caption         =   $"directquerycheck.frx":033C
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
